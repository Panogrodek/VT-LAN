...
\begin{itemize}
    ...
    AES-GCM-256 z wymianą kluczy X25519, zapewniające poufność, integralność
    ...
    zrealizowana w Dear ImGui renderowanym przez SDL3/Vulkan. Widoki:
...
problemów z uruchomieniem i połączeniem zawarte są w pliku
\texttt{README.md} dostępnym w repozytorium projektu pod adresem
\url{https://github.com/Panogrodek/VT-LAN}. Dokument ten jest na bieżąco
