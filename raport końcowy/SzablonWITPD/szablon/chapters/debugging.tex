...
Dodatkowym argumentem przemawiającym za pomięciem osobnych testów
...
\begin{figure}[htbp]
	...
	\label{fig:db_test_dwa_urzadzenia}
\end{figure}

\begin{figure}[htbp]
	\centering
	\includegraphics[width=1\textwidth]{figures/urzadzenie 2.png}
	\caption{Test komunikacji między dwoma różnymi urządzeniami
...
Wyniki (\cref{fig:db_test_dwa_urzadzenia}) potwierdziły:
...
\begin{itemize}
	...
	RAM w granicach 70\,MB, obciążenie CPU na poziomie ok.\ 1\%,
	...
	AES-GCM-256 przez pełną obfuskację zawartości pakietów UDP,
