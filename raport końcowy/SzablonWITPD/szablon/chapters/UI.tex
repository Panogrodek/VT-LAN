...
\begin{figure}[H]
	...
	\caption{Referencyjny układ Discorda: kanały, czat, uczestnicy i sterowanie
		głosem (opracowanie własne na podstawie~\cite{Discord}).}
...
\begin{figure}[H]
	...
	\caption{Referencyjny układ TeamSpeak: serwer, kanały i czat kanału
		(opracowanie własne na podstawie~\cite{TeamSpeak}).}
...
\begin{figure}[H]
	...
	\caption{Referencyjny układ Microsoft Teams: spotkanie, czat i udostępnianie
		treści (opracowanie własne na podstawie~\cite{MSTeams}).}
	\label{fig:ui_teams}
\end{figure}
...
obsługę inicjacji sesji z poziomu linku opisano w sekcji~\ref{sec:tcp}.
