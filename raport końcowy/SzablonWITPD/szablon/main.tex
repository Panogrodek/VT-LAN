...
\newcommand{\stTytulAng}{An application for voice and text communication over a local area network (LAN)}
...
\newcommand{\stSlowaKluczowe}{komunikator LAN, VoIP, kodek Opus, GameNetworkingSockets, SDL3, C++, szyfrowanie AES-256-GCM}
